...
def setup_logger(name='dasher', log_level=logging.INFO, log_to_file=True, log_to_console=True):
    """
...
def configure_from_env():
    ...
    global logger
    logger = setup_logger(log_level=log_level, log_to_file=log_to_file, log_to_console=log_to_console)
    
    logger.info(f"Logger configured with level={log_level_name}, file={log_to_file}, console={log_to_console}")
